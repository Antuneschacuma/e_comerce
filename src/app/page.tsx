...
const carouselImages = [
  {
    src: '/images/calili/IMG-20250408-WA0029.jpg',
    alt: 'Promoção de Cassimbo',
    title: 'Promoção de Cassimbo',
    subtitle: 'Até 15% de desconto em lonas e banners',
    cta: 'Ver Ofertas'
  },
  {
    src: '/images/calili/IMG-20250408-WA0023.jpg',
    alt: 'Novos Produtos',
  ...
  {
    src: '/images/calili/IMG-20250408-WA0008.jpg',
    alt: 'Tudo para dar brilho para o seu negócio',
    title: 'Tudo para dar brilho ao seu negócio',
    subtitle: 'Materiais de alta qualidade para promover sua marca',
    cta: 'Condições'
  }
];
      ...
      <section className="py-8 bg-indigo-900/5">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-80 hover:opacity-100 transition-opacity">
            {['impressao', 'timbragem', 'brindes', 'montagem', 'e muito+'].map((brand, index) => (
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-100 text-indigo-700 mb-6">
            ...
            <span className="text-sm font-medium">Líder em publicidade</span>
          </div>
          
          <h1 className="text-5xl font-bold text-indigo-900 mb-6 leading-tight">
            Materiais de Construção de <br />
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            Fornecendo soluções em materiais de construção para Angola desde 2008, com compromisso, qualidade e atendimento personalizado.
          </p>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-indigo-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Excelência em materiais de construção com atendimento personalizado
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-700 to-indigo-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            Nossa equipe está pronta para te ajudar a encontrar os melhores materiais para sua construção.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/contato"
